...
export const boardApi = {
  ...
  delete: (project: string, board: string) => fizzaApi.deleteBoard(project, board),
  ...
  listArchived: (project: string, board: string) => fizzaApi.listArchived(project, board),
  archiveDone: (project: string, board: string) => fizzaApi.archiveDone(project, board),
};
